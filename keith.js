...
// COLOR CONSTANTS
const { RED, MAROON, BLACK, WHITE, BLUE } = require('raylib')

// Objects
const { Rectangle, Vector2 } = require('raylib')
...
const ballSize = 50
const ballSpeed = 10
let ballColorArray = [RED, BLACK, BLUE]
...
while (!WindowShouldClose()) {
  ...
  if (frameCounter++ == (frameRate * randomizerRate)) {
